...
function winCondition() {
  if (squares[0].innerText === 'X' && squares[1].innerText === 'X' && squares[2].innerText === 'X') {
    declareWinner.innerText = 'Player One (X) has won'
    ...
    playerNow.innerText = 'Game Over'
    gameInProgress = false
  } else if (squares[0].innerText === 'X' && squares[4].innerText === 'X' && squares[7].innerText === 'X') {
    declareWinner.innerText = 'Player One (X) has won'
    playerNow.innerText = 'Game Over'
    gameInProgress = false
    ...
    declareWinner.innerText = 'Player One (O) has won'
    playerNow.innerText = 'Game Over'
    gameInProgress = false
    ...
    playerNow.innerText = 'Game Over'
    gameInProgress = false
  } else if (squares[0].innerText === 'O' && squares[4].innerText === 'O' && squares[7].innerText === 'O') {
    declareWinner.innerText = 'Player One (O) has won'
    playerNow.innerText = 'Game Over'
    gameInProgress = false
